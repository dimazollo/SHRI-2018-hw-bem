# Домашнее задание ШРИ по BEM, ReactJS и bem-react

Новый репозиторий создан под эту домашнюю работу потому, что для переноса проекта на React и BEM 
потребовалось переделать всё практически с нуля.
...
- [Proxying API Requests in Development](#proxying-api-requests-in-development)
  - ["Invalid Host EventCardHeader" Errors After Configuring Proxy](#invalid-host-header-errors-after-configuring-proxy)
...
### "Invalid Host EventCardHeader" Errors After Configuring Proxy
